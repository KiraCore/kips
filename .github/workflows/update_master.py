...
kip_directory = 'kips/'
readme_header_path = 'includes/README_upper.md'  # Readme content above kips table (incl table title)
readme_footer_path = 'includes/README_lower.md'  # Readme content below
